...
image_ufo = 'ufo.png'
image_buu = 'bullet.png'
image_ast = 'asteroid.png'
score = 0
lost = 0
goal = 10
max_lost = 3
...
class Player(GameSprite):
    def update(self):
        ...
        if keys[K_RIGHT] and self.rect.x < win_width - 80:
            self.rect.x += self.speed
    def fire(self):
        bullet = Bullet(image_buu, self.rect.centerx, self.rect.top, 15, 20, -15)
        bullets.add(bullet)
...
for i in range(1, 6):
    monster = Enemy(image_ufo, randint(80, win_width - 80), -40, 80, 50, randint(1, 5))
    monsters.add(monster)

asteroids = sprite.Group()
for i in range(1, 4):
    asteroid = Asteroid(image_ast, randint(80, win_width - 80), -40, 80, 50, randint(1, 5), randint(0, 1))
